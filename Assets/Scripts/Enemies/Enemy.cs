...
public class Enemy : MonoBehaviour
{
    ...
    /// </summary>
    public enum MovementModes { NoMovement, FollowTarget, Scroll, Stationary};
    ...
    private void Start()
    {
        ...
        if ((movementMode == MovementModes.FollowTarget ||  movementMode == MovementModes.Stationary) && (followTarget == null || lookatTarget == null) )
        {
            if (GameManager.instance != null && GameManager.instance.player != null)
            {
				...
				if((difficulty == 0 && random<=20) || (difficulty == 1 && random<= 10) || (difficulty == 2 && random<=5)){
					Special = true;
				}
    ...
    private void HandleBehaviour()
    {
        ...
        if ( (lookatTarget != null || followTarget != null) && (followTarget.position - transform.position).magnitude < followRange)
        {
            MoveEnemy();
        }
    ...
    /// void (no return)
    /// </summary>
    public void DoBeforeDestroy(GameObject collision)
    {
